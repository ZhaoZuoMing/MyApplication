	...
	private void initContentAdapterView() {
		...
		if (count < 3) {
			throw new IllegalArgumentException(
					"this search_flight_layout must contain 3 child views,and AdapterView or ScrollView must in the second position!");
		}
		View view = null;
		...
		if (mAdapterView == null && mScrollView == null) {
			throw new IllegalArgumentException(
					"must contain a AdapterView or ScrollView in this search_flight_layout!");
		}
	}
...
//			mHeaderTextView.startAnimation(mFlipAnimation);
...
//		mHeaderTextView.setImageResource(R.mipmap.arrow_flash);
		mHeaderTextView.setText(R.string.pull_to_refresh_pull_label);
	...
	public void onFooterRefreshComplete() {
		setHeaderTopMargin(-mHeaderViewHeight);
		mFooterImageView.setVisibility(View.GONE);
		mFooterImageView.setImageResource(R.mipmap.arrow_flash);
		mFooterTextView.setText(R.string.pull_to_refresh_footer_pull_label);
		mFooterProgressBar.setVisibility(View.GONE);
		// mHeaderUpdateTextView.setText("");
		mFooterState = PULL_TO_REFRESH;
